...
svmPHHP1 = train(Group~., data=phhp1Train,method="mlpML", trControl=fitControl )
svmPHHP4 = train(Group~., data=phhp4Train,method="mlpML", trControl=fitControl )
svmPHHP9 = train(Group~., data=phhp9Train,method="mlpML", trControl=fitControl )
svmP1P4 = train(Group~., data=p1p4Train,method="mlpML", trControl=fitControl )
svmP1P9 = train(Group~., data=p1p9Train,method="mlpML", trControl=fitControl )
svmP4P9 = train(Group~., data=p4p9Train,method="mlpML", trControl=fitControl )
