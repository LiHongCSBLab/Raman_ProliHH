...
svmPHHP1 = train(Group~., data=phhp1Train,method="ranger", trControl=fitControl )
svmPHHP4 = train(Group~., data=phhp4Train,method="ranger", trControl=fitControl )
svmPHHP9 = train(Group~., data=phhp9Train,method="ranger", trControl=fitControl )
svmP1P4 = train(Group~., data=p1p4Train,method="ranger", trControl=fitControl )
svmP1P9 = train(Group~., data=p1p9Train,method="ranger", trControl=fitControl )
svmP4P9 = train(Group~., data=p4p9Train,method="ranger", trControl=fitControl )
